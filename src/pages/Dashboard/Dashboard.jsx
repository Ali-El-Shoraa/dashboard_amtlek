...
import CardEAmployees from "./components/CardEAmployees";
...
import PropertiesTypes from "./components/charts/PropertiesTypes";
import VendorChart from "./components/charts/VendorChart";
import BestPackagesUsageChart from "./components/charts/BestPackagesUsageChart";
      ...
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <main className="grow">
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            {/* card Accounting data */}
            <div className="grid grid-cols-3 gap-6 mb-6">
              <CardAccounting bg_color_card={`bg-custome-red`} />
              <CardAccounting bg_color_card={`bg-custome-green`} />
              <CardAccounting bg_color_card={`bg-purple-clouds`} />
            </div>
            ...
            {/* cards [vendor, Users, Amtalek employees, Normal Properties, Featured Properties, Leads Amtalek] */}
            <div className="grid grid-cols-3 gap-6 mb-6">
              <CardEAmployees />
              <CardEAmployees />
              <CardEAmployees />
            ...
            <div className="flex gap-2 mb-9 h-[440px]">
              <div className="w-3/5">
                <LeadsPipeLineChart />
              </div>
