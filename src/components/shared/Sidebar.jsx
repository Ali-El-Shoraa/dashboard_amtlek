...
// // بيانات القائمة مفصّلة في مصفوفة مع تقسيمها لأقسام
const menuData = [
  {
    section: "Dashboard",
    items: {
  ...
  },
  {
    ...
    items: {
      ...
      icon: <IoIosHome />,
      arrowButton: <MdOutlineKeyboardArrowDown />,
      active: true,
      children: [
        {
          id: 21,
        ...
        {
          id: 22,
          label: "All Sent Notifications",
          link: "/all-sent-notifications",
          badge: "124",
        },
      ],
    },
...
// // مكون عنصر القائمة (يدعم القوائم الفرعية بشكل تكراري)
// const MenuItem = ({ item }) => {
...
//         <NavLink
//           to={item.link}
//           className="flex items-center space-x-2 text-gray-800 hover:text-blue-500 transition-colors duration-200"
//         >
...
//           className="flex items-center w-full space-x-2 text-gray-800 hover:text-blue-500 transition-colors duration-200 focus:outline-none"
//         >
//           {item.icon && <span>{item.icon}</span>}
//           <span>{item.label}</span>
//           {hasChildren && (
...
//       {/* عرض القائمة الفرعية مع تأثير حركة عند الفتح والإغلاق */}
//       {hasChildren && (
//         <ul
//           style={{ transformOrigin: "top" }}
//           className={`pl-6 mt-2 space-y-1 transition-transform duration-300 ease-in-out ${
...
//           <h3 className="px-4 py-2 text-gray-500 uppercase tracking-wider text-[10px] fon-bold">
//             {section.section}
//           </h3>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <span className="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3">
                Pages
              </span>
              {/* E-Commerce */}
              <SidebarLinkGroup
